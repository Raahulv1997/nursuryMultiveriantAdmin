        ...
        this.each(function () {
          ...
          (A.VBclose = function () {
            ...
            D.on("click", function (u) {
              ...
              switch (
                ...
                (P = '<div className="vbox-preloader">'),
                H.spinner)
              ) {
                case "rotating-plane":
                  P += '<div className="sk-rotating-plane"></div>';
                  break;
                case "double-bounce":
                  P +=
                ...
                case "wandering-cubes":
                  ...
                  break;
                case "spinner-pulse":
                  P += '<div className="sk-spinner sk-spinner-pulse"></div>';
                  break;
                case "chasing-dots":
                  P +=
              ...
              return (
                (P += "</div>"),
                (O =
                  '<Link className="vbox-next">' +
                  H.htmlNext +
                  '</Link><Link className="vbox-prev">' +
                  H.htmlPrev +
                  "</Link>"),
                (U =
                  '<div className="vbox-title"></div><div className="vbox-num">0/0</div><div className="vbox-close">' +
                  H.htmlClose +
                  "</div>"),
                (t =
          ...
          function ie() {
            e.ajax({ url: l, cache: !1 })
              .done(function (e) {
                d.html('<div className="vbox-inline">' + e + "</div>"), te();
              })
              .fail(function () {
                d.html(
          ...
          function ae() {
            d.html('<iframe className="venoframe" src="' + l + '"></iframe>'),
              de();
          }
          function ce(e) {
            var s,
          ...
          function oe() {
            d.html('<div className="vbox-inline">' + e(l).html() + "</div>"),
              de();
          }
          function te() {
            (V = d.find("img")).length
